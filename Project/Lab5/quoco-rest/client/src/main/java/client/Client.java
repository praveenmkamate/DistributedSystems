...
public class Client {
    ...
    public static void main(String args[]) {
        ...
        for(int i=0;i<clients.length;i++){
            ...
            ClientApplication result = restTemplate.postForObject("http://localhost:8084/applications",
                            request, ClientApplication.class);
            displayProfile(result.getInfo());
            List<Quotation> quotationList = result.getQuotations();
